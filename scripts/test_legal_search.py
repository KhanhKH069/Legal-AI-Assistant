...
# -*- coding: utf-8 -*-
"""
Quick test script for Legal AI Assistant backend

Tests:
  1. ChromaDB collection counts
  2. Statutory law search (Phap dien)
  3. Case law search (An le)
  4. FastAPI /health endpoint

Usage:
  python scripts/test_legal_search.py
"""
